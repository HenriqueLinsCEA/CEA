...
public class JfTelaPrincipal extends JFrame {
	...
	public JfTelaPrincipal() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(JfTelaPrincipal.class.getResource("/image/ne.png")));
		...
		lblLogo.setIcon(new ImageIcon(JfTelaPrincipal.class.getResource("/image/logo_ne_solution.png")));
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(223)
					.addComponent(lblLogo, GroupLayout.DEFAULT_SIZE, 527, Short.MAX_VALUE)
					.addGap(224))
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(31)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(67)
					.addComponent(lblLogo, GroupLayout.DEFAULT_SIZE, 235, Short.MAX_VALUE)
					.addGap(163)
