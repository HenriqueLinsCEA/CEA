...
public class JdImpressaoTESTE extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JdImpressaoTESTE dialog = new JdImpressaoTESTE();
	 ...
	 * Create the dialog.
	 */
	public JdImpressaoTESTE() {
		setModal(true);
		setResizable(false);
		setIconImage(Toolkit
				.getDefaultToolkit()
				.getImage(
						JdImpressaoTESTE.class
		...
		lblNewLabel.setIcon(new ImageIcon(JdImpressaoTESTE.class
