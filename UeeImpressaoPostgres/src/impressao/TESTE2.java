...
public class TESTE2 extends JPanel implements ActionListener{ 
...
f.getContentPane().add(BorderLayout.CENTER, new TESTE2()); 
f.setSize(775, 450); 
f.show(); 
} 
...
Font fnt = new Font("Helvetica-Bold", Font.PLAIN, 4); 
...
public int print(Graphics g, PageFormat pf, int pageIndex) 
throws PrinterException { 
TESTE2.drawShapes((Graphics2D) g); 
return Printable.PAGE_EXISTS; 
