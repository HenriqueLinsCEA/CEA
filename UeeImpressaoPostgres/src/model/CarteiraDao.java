...
public class CarteiraDao {
	...
	public int inserirDadosCarteira(Carteira carteira) {
		...
		String sql = "INSERT INTO carteira  (nome,  instituicao, curso, matricula, data_nascimento, rg) VALUES (?, ?, ?, ?, ?, ?) returning id_carteira ";

		try {

			PreparedStatement declarar = conexaoBanco.prepareStatement(sql);

			declarar.setString(1, carteira.getNome());
			declarar.setString(2, carteira.getInstituicao());
			declarar.setString(3, carteira.getCurso());
			declarar.setString(4, carteira.getMatricula());
			declarar.setString(5, carteira.getDataNascimento());
			declarar.setString(6, carteira.getRg());
									
			ResultSet resultado = declarar.executeQuery();

			while (resultado.next()) {

				id_carteira = resultado.getInt("id_carteira");
...
public List<Carteira> pesquisarMultiplosCampos(String campo, String pesquisa) {
